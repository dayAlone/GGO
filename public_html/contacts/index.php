...
<div class="row">
  <div class="col-xs-7">
    <h3 class="no-margin-top">ОАО «Гипрогазоочистка»</h3>
  ...
  <div class="col-xs-5 right"><a data-toggle="modal" data-target="#Feedback" href="#Feedback" class="button">НАПИШИТЕ НАМ</a></div>
</div>
<?
