...
$APPLICATION->SetTitle('GGO in figures');
?> 
<div class="numbers visible-xs">
  ...
  <div class="row">
    <div class="col-xs-9 s-line-height">
      <u>The "quickest" project — from signing the contract to delivering<br>the designed equipment — took<br>only <strong>6 months</strong> to complete</u>
    </div>
    <div class="col-xs-3">
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="row">
        ...
        <div class="col-xs-3"><div class="xs-line-height"><em>We have chartered over</em></div>
          <div class="number__value number__value--xs">100</div>
        </div>
        <div class="col-xs-6">
          <div class="xs-line-height m-margin-left">
            <u>means of transport (ships, oversized vehicles, standard 53-foot trailers, and aircraft) for logistics purposes</u>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-xs-8 border-right">
      <div class="number__value number__value--xxs">10,5<small> million</small></div>
      <div class="xs-line-height"><em>tons of feedstock is processed by process units designed by GGO </em></div>
    </div>
    <div class="col-xs-4 center">
      <div class="number__value number__value--xs">125</div>
      <div class="xs-line-height"><em>subcontractors </em></div>
    </div>
  </div>
  <div class="page__divider xl-margin-top m-margin-bottom"></div>
  <div class="row">
...
<div class="numbers visible-sm">
  ...
  <div class="row">
    <div class="col-sm-4 border-right border-right--medium">
      <div class="row">
        ...
        <div class="col-xs-8"><div class="xs-line-height"><em>We have chartered over</em></div>
          <div class="number__value number__value--xs">100</div>
        </div>
      </div>
      <div class="xs-line-height">
    ...
    <div class="col-sm-8">
      <div class="row">
        <div class="col-xs-4 border-right center s-padding-top">
          <div class="number__value number__value--xxs">158</div><small>partners</small>
        </div>
        <div class="col-xs-7">
          <div class="row">
            <div class="col-xs-9 s-line-height">
  ...
  <div class="row">
    <div class="col-xs-4 border-right">
      <div class="number__value number__value--xxs">10,5<small> million</small></div>
      <div class="s-line-height"><em>tons of feedstock is processed by process units designed by GGO </em></div>
      <div class="page__divider m-margin-top m-margin-bottom"></div>
      <div class="row">
        <div class="col-xs-5">
          <div class="number__value number__value--xs">125</div>
    ...
    <div class="col-xs-8">
      <div class="row row--padding">
        ...
        <div class="col-xs-10 col-xs-offset-2">
          <div class="xl-margin-left"><small>means of transport (ships, oversized vehicles, standard 53-foot trailers, and aircraft) for logistics purposes</small></div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row row--padding">
        <div class="col-xs-6 border-right">
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              <div class="m-line-height s-margin-left-lg xs-margin-top-lg m-margin-top-sm"><em>subcontractors </em></div>
            </div>
          </div>
        </div>
        <div class="col-xs-5">
