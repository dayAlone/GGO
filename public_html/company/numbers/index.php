            ...
            <div class="col-xs-6">
              ...
              <div class="row">
                <div class="col-xs-8 s-line-height">
                  <u>Самый «быстрый» проект – от заключения договора до<br>поставки спроектированного<br>нами оборудования – был<br>реализован всего за <strong>6 месяцев</strong></u>
                </div>
          ...
          <div class="row row--padding">
            <div class="col-xs-6 border-right">
              ...
              <div class="row">
                ...
                <div class="col-xs-6">
                  <div class="m-line-height s-margin-left xs-margin-top"><em>Подрядных организаций</em></div>
                </div>
              </div>
            </div>
            <div class="col-xs-5">
          ...
          <div class="row row--padding">
            ...
            <div class="col-xs-5">
              <div class="row">
                ...
                <div class="col-xs-10 right m-line-height"><small>Наша проектная документация получает положительное заключение Главгосэкспертизы с первого раза. </small></div>
              </div>
